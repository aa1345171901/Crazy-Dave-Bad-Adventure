...
public class ConfPlantCardsBase : ConfBase<ConfPlantCardsItem>
{
	...
	private void Init1()
	{
		...
		AddItem(new ConfPlantCardsItem(2, "plantName_Repeater", "Shop/Plants/strongBg", "Shop/Plants/Repeater", 25, 100, "plantInfo_Repeater", 2, 2));
		...
		AddItem(new ConfPlantCardsItem(6, "plantName_CherryBomb", "Shop/Plants/normalBg", "Shop/Plants/CherryBomb", 70, 150, "plantInfo_CherryBomb", 6, 2));
		...
		AddItem(new ConfPlantCardsItem(9, "plantName_CornpultCard", "Shop/Plants/normalBg", "Shop/Plants/CornpultCard", 30, 100, "plantInfo_CornpultCard", 9, 2));
		...
		AddItem(new ConfPlantCardsItem(14, "plantName_LilyPad", "Shop/Plants/normalBg", "Shop/Plants/LilyPad", 15, 25, "plantInfo_LilyPad", 14, 0));
		AddItem(new ConfPlantCardsItem(15, "plantName_Gralic", "Shop/Plants/normalBg", "Shop/Plants/Gralic", 35, 50, "plantInfo_Gralic", 15, 1));
		AddItem(new ConfPlantCardsItem(16, "plantName_Gravebuster", "Shop/Plants/normalBg", "Shop/Plants/Gravebuster", 70, 75, "plantInfo_Gravebuster", 16, 3));
		...
		AddItem(new ConfPlantCardsItem(23, "plantName_ScaredyShroom", "Shop/Plants/normalBg", "Shop/Plants/ScaredyShroom", 20, 25, "plantInfo_ScaredyShroom", 23, 1));
		...
		AddItem(new ConfPlantCardsItem(28, "plantName_Starfruit", "Shop/Plants/normalBg", "Shop/Plants/Starfruit", 90, 125, "plantInfo_Starfruit", 28, 3));
