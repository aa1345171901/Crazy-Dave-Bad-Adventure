...
public class ConfPropCardsItem : ConfBaseItem
{
	...
	public ConfPropCardsItem(int id, string propName, string propImagePath, int defaultPrice, string info, int quality, int propType, int value1, int coolingTime, int maxNum, string attributes)
	{
		this.id = id;
...
public class ConfPropCardsBase : ConfBase<ConfPropCardsItem>
{
	...
	private void Init1()
	{
		...
		AddItem(new ConfPropCardsItem(86, "zombieBanOrder", "Shop/Props/zombieBanOrder", 15, "propInfo_zombieBanOrder", 1, 5, -10, 0, 4, "[{\"attributeTypeString\":\"LifeRecovery\",\"increment\":\"5\"},{\"attributeTypeString\":\"Power\",\"increment\":\"-1\"}]"));
