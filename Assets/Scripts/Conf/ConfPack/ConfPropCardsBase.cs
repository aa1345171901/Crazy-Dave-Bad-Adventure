...
public class ConfPropCardsBase : ConfBase<ConfPropCardsItem>
{
	...
	private void Init1()
	{
		...
		AddItem(new ConfPropCardsItem(92, "mint", "Shop/Props/mint", 64, "propInfo_mint", 2, 0, 8, 0, 5, "purpleGarlic", "[{\"attributeTypeString\":\"MaximumHP\",\"increment\":\"5\"},{\"attributeTypeString\":\"LifeRecovery\",\"increment\":\"4\"}]"));
	}
