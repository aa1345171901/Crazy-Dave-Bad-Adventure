...
public class ConfWaveBase : ConfBase<ConfWaveItem>
{
	...
	private void Init1()
	{
		...
		AddItem(new ConfWaveItem(301, 3, 0, new int[]{ 2, 4, 6 }, new float[]{ 4f, 2.8f, 1.8f }, 0));
		AddItem(new ConfWaveItem(401, 4, 0, new int[]{ 3, 5, 7 }, new float[]{ 4f, 2.6f, 1.6f }, 0));
		AddItem(new ConfWaveItem(501, 5, 0, new int[]{ 2, 3, 4 }, new float[]{ 4f, 2.5f, 2f }, 0));
		AddItem(new ConfWaveItem(502, 5, 7, new int[]{ 1, 1, 2 }, new float[]{ 4f, 3f, 2.5f }, 2));
		AddItem(new ConfWaveItem(601, 6, 0, new int[]{ 2, 3, 3 }, new float[]{ 4f, 3f, 2f }, 0));
		AddItem(new ConfWaveItem(602, 6, 1, new int[]{ 1, 1, 2 }, new float[]{ 8f, 8f, 10f }, 1));
		AddItem(new ConfWaveItem(603, 6, 7, new int[]{ 1, 1, 2 }, new float[]{ 4f, 4f, 3f }, 2));
		AddItem(new ConfWaveItem(701, 7, 0, new int[]{ 2, 3, 4 }, new float[]{ 3.5f, 2.5f, 1.5f }, 0));
		AddItem(new ConfWaveItem(702, 7, 1, new int[]{ 1, 1, 2 }, new float[]{ 8f, 8f, 10f }, 1));
		AddItem(new ConfWaveItem(703, 7, 7, new int[]{ 1, 1, 2 }, new float[]{ 4f, 4f, 3f }, 2));
		AddItem(new ConfWaveItem(704, 7, 4, new int[]{ 1, 1, 1 }, new float[]{ 8f, 8f, 6f }, 3));
		AddItem(new ConfWaveItem(801, 8, 0, new int[]{ 2, 3, 4 }, new float[]{ 3.5f, 2.5f, 1.5f }, 0));
		AddItem(new ConfWaveItem(802, 8, 1, new int[]{ 1, 1, 2 }, new float[]{ 6f, 6f, 8f }, 1));
		AddItem(new ConfWaveItem(803, 8, 7, new int[]{ 1, 1, 2 }, new float[]{ 4f, 4f, 3f }, 2));
		...
		AddItem(new ConfWaveItem(1001, 10, 0, new int[]{ 2, 2, 2 }, new float[]{ 3.5f, 2.5f, 1.5f }, 0));
		AddItem(new ConfWaveItem(1002, 10, 1, new int[]{ 1, 1, 1 }, new float[]{ 6f, 6f, 8f }, 1));
		AddItem(new ConfWaveItem(1003, 10, 4, new int[]{ 1, 1, 1 }, new float[]{ 6f, 6f, 5f }, 2));
		AddItem(new ConfWaveItem(1004, 10, 11, new int[]{ 1, 1, 1 }, new float[]{ 200f, 200f, 200f }, 0));
		AddItem(new ConfWaveItem(1101, 11, 0, new int[]{ 2, 2, 2 }, new float[]{ 3.5f, 2.5f, 1.5f }, 0));
		...
		AddItem(new ConfWaveItem(1104, 11, 7, new int[]{ 1, 1, 1 }, new float[]{ 4f, 3f, 2f }, 2));
		...
		AddItem(new ConfWaveItem(1309, 13, 10, new int[]{ 1, 1, 1 }, new float[]{ 6f, 66f }, 8));
		...
		AddItem(new ConfWaveItem(1409, 14, 10, new int[]{ 1, 1, 1 }, new float[]{ 6f, 66f }, 8));
		AddItem(new ConfWaveItem(1501, 15, 0, new int[]{ 3, 3, 4 }, new float[]{ 3.5f, 3f, 2.5f }, 0));
		AddItem(new ConfWaveItem(1502, 15, 3, new int[]{ 1, 1, 1 }, new float[]{ 8f, 8f, 6f }, 8));
		AddItem(new ConfWaveItem(1503, 15, 6, new int[]{ 1, 1, 1 }, new float[]{ 5f, 5f, 4f }, 4));
		AddItem(new ConfWaveItem(1504, 15, 7, new int[]{ 1, 1, 1 }, new float[]{ 6f, 6f, 4f }, 6));
		AddItem(new ConfWaveItem(1505, 15, 9, new int[]{ 1, 1, 1 }, new float[]{ 10f, 8f, 6f }, 2));
		AddItem(new ConfWaveItem(1506, 15, 11, new int[]{ 1, 1, 1 }, new float[]{ 200f, 200f, 200f }, 0));
		...
		AddItem(new ConfWaveItem(1610, 16, 10, new int[]{ 1, 1, 1 }, new float[]{ 6f, 66f }, 8));
		...
		AddItem(new ConfWaveItem(1710, 17, 10, new int[]{ 1, 1, 1 }, new float[]{ 6f, 66f }, 8));
		AddItem(new ConfWaveItem(1801, 18, 1, new int[]{ 4, 4, 4 }, new float[]{ 3f, 2f, 2f }, 0));
		AddItem(new ConfWaveItem(1802, 18, 7, new int[]{ 3, 3, 4 }, new float[]{ 3f, 2f, 2f }, 4));
		AddItem(new ConfWaveItem(1901, 19, 1, new int[]{ 4, 4, 4 }, new float[]{ 3f, 2f, 2f }, 0));
		AddItem(new ConfWaveItem(1902, 19, 7, new int[]{ 2, 2, 2 }, new float[]{ 3f, 2f, 2f }, 8));
		AddItem(new ConfWaveItem(1903, 19, 6, new int[]{ 3, 3, 3 }, new float[]{ 3f, 3f, 3f }, 2));
		AddItem(new ConfWaveItem(2001, 20, 1, new int[]{ 3, 3, 3 }, new float[]{ 4f, 4f, 4f }, 0));
		AddItem(new ConfWaveItem(2002, 20, 2, new int[]{ 1, 1, 1 }, new float[]{ 4f, 4f, 4f }, 8));
		AddItem(new ConfWaveItem(2003, 20, 3, new int[]{ 1, 1, 1 }, new float[]{ 8f, 8f, 6f }, 8));
		AddItem(new ConfWaveItem(2004, 20, 4, new int[]{ 1, 1, 1 }, new float[]{ 4f, 4f, 3f }, 6));
		AddItem(new ConfWaveItem(2005, 20, 5, new int[]{ 1, 1, 1 }, new float[]{ 20f, 15f, 15f }, 4));
		AddItem(new ConfWaveItem(2006, 20, 6, new int[]{ 1, 1, 1 }, new float[]{ 5f, 5f, 4f }, 4));
		AddItem(new ConfWaveItem(2007, 20, 7, new int[]{ 1, 1, 1 }, new float[]{ 6f, 6f, 4f }, 6));
		AddItem(new ConfWaveItem(2008, 20, 8, new int[]{ 1, 1, 1 }, new float[]{ 10f, 8f, 6f }, 2));
		AddItem(new ConfWaveItem(2009, 20, 9, new int[]{ 1, 1, 1 }, new float[]{ 20f, 6f, 4f }, 0));
		AddItem(new ConfWaveItem(2010, 20, 10, new int[]{ 1, 1, 1 }, new float[]{ 30f, 66f }, 8));
		AddItem(new ConfWaveItem(2011, 20, 11, new int[]{ 1, 1, 1 }, new float[]{ 90f, 90f, 90f }, 45));
		AddItem(new ConfWaveItem(2022, 20, 12, new int[]{ 1, 1, 1 }, new float[]{ 9999f, 9999f, 9999f }, 0));
	}
