...
public class ConfLocalTextBase : ConfBase<ConfLocalTextItem>
{
	...
	private void Init1()
	{
		...
		AddItem(new ConfLocalTextItem(153, "mainmenu_dash", "翻滚", "Roll"));
		AddItem(new ConfLocalTextItem(154, "mainmenu_continuetip", "继续游戏还是重新开始\r\n检测到你有存档\r\n你可以选择继续游戏或者重新开始\r\n如果重新开始你的<color=#ff0000>存档将会删除</color>", "Continue the game or restart\r\nDetect that you have a save file\r\nYou can choose to continue the game or restart\r\nIf you restart, your <color=#ff0000>save file will be deleted</color>"));
		AddItem(new ConfLocalTextItem(155, "mainmenu_boss", "僵 王 模 式", "Zombie King"));
		AddItem(new ConfLocalTextItem(156, "mainmenu_start", "开 始 冒 险", "Start Adventure"));
		AddItem(new ConfLocalTextItem(157, "mainmenu_loading", "加载游戏中，请耐心等待。。。", "Loading the game, please be patient and wait..."));
		AddItem(new ConfLocalTextItem(158, "mainmenu_seting", "更 改 设 置", "Change settings"));
		AddItem(new ConfLocalTextItem(159, "mainmenu_fullscreen", "全屏显示", "Full Screen"));
		AddItem(new ConfLocalTextItem(160, "mainmenu_resolution", "分辨率", "Resolution"));
		AddItem(new ConfLocalTextItem(161, "mainmenu_previouskey", "之前的键", "Previous key"));
		AddItem(new ConfLocalTextItem(162, "mainmenu_change", "更改", "Change"));
		AddItem(new ConfLocalTextItem(163, "mainmenu_inputkey", "请输入任意键", "Please enter any key"));
		AddItem(new ConfLocalTextItem(164, "mainmenu_errorinput", "<color=#ff0000>不能有相同的键</color>\r\n输入任意键继续", "<color=#ff0000>Cannot have the same key</color>\r\nEnter any key to continue"));
		AddItem(new ConfLocalTextItem(165, "mainmenu_exitgame", "退 出 游 戏", "Exit Game"));
		AddItem(new ConfLocalTextItem(166, "mainmenu_language", "语言", "Language"));
		AddItem(new ConfLocalTextItem(167, "cannot_buy1", "她很好，我不配，因为我没有钱钱", "She is very good, but I don't deserve her because I don't have money."));
		AddItem(new ConfLocalTextItem(168, "cannot_buy2", "越没钱的时候越想花钱，穷到要吃土l", "The less money you have, the more you want to spend it. You will be so poor that you have to eat dirt."));
		AddItem(new ConfLocalTextItem(169, "cannot_buy3", "购物车里的东西只能看着下架", "The items in the shopping cart can only be taken off the shelves"));
		AddItem(new ConfLocalTextItem(170, "cannot_plant1", "没有花盆植物不能种植", "Plants cannot be grown without pots"));
		AddItem(new ConfLocalTextItem(171, "cannot_plant2", "植物只能在<color=#ff0000>花盆</color>上培养,花盆可以通过<color=#ff0000>刷新</color>进行获取", "Plants can only be grown in <color=#ff0000>flower pots</color>, and flower pots can be obtained by <color=#ff0000>refreshing</color>"));
		AddItem(new ConfLocalTextItem(172, "cannot_plant3", "花盆肥肠重要！！", "Flower pot sausage is important!!"));
		AddItem(new ConfLocalTextItem(173, "cannot_plant4", "荷叶需要种植在<color=#ff0000>水花盆</color>里\n需要先购买<color=#ff0000>水花盆</color>", "Lotus leaves need to be planted in a <color=#ff0000>water flower pot</color>\nYou need to buy a <color=#ff0000>water flower pot</color> first"));
		AddItem(new ConfLocalTextItem(174, "flowerpot_info1", "这是在进货时捡到的花盆\n可以在花园中<color=#00ff00>培养植物</color>", "This is a flower pot I picked up when I was restocking.\nYou can <color=#00ff00>cultivate plants</color> in the garden."));
		AddItem(new ConfLocalTextItem(175, "flowerpot_info2", "花园中已经不能够放下更多的花盆了\n或许可以用<color=#ff0000>铲子</color>铲掉泥巴", "There is no room for any more flower pots in the garden.\nPerhaps you can use a <color=#ff0000>shovel</color> to shovel away the mud"));
		AddItem(new ConfLocalTextItem(176, "property_Property", "属性", "Property"));
		AddItem(new ConfLocalTextItem(177, "property_MaximumHP", "最大生命值", "MaximumHP"));
		AddItem(new ConfLocalTextItem(178, "property_LifeRecovery", "生命恢复", "LifeRecovery"));
		AddItem(new ConfLocalTextItem(179, "property_Adrenaline", "肾上腺素", "Adrenaline"));
		AddItem(new ConfLocalTextItem(180, "property_Power", "力量", "Power"));
		AddItem(new ConfLocalTextItem(181, "property_PercentageDamage", "%伤害", "%PercentageDamage"));
		AddItem(new ConfLocalTextItem(182, "property_AttackSpeed", "%攻击速度", "%AttackSpeed"));
		AddItem(new ConfLocalTextItem(183, "property_Range", "%范围", "%Range"));
		AddItem(new ConfLocalTextItem(184, "property_CriticalHitRate", "%暴击率", "%CriticalHitRate"));
		AddItem(new ConfLocalTextItem(185, "property_MoveSpeed", "%移动速度", "%MoveSpeed"));
		AddItem(new ConfLocalTextItem(186, "property_Armor", "护甲", "Armor"));
		AddItem(new ConfLocalTextItem(187, "property_Lucky", "幸运", "Lucky"));
		AddItem(new ConfLocalTextItem(188, "property_Sunshine", "阳光", "Sunshine"));
		AddItem(new ConfLocalTextItem(189, "property_GoldCoins", "金币", "GoldCoins"));
		AddItem(new ConfLocalTextItem(190, "property_Botany", "植物学", "Botany"));
		AddItem(new ConfLocalTextItem(191, "garden_wave", "当前为第<color=#ffff00>{0}</color>波", "The current wave is <color=#ffff00>{0}</color>"));
		AddItem(new ConfLocalTextItem(192, "garden_nourish", "培养", "Nourish"));
		AddItem(new ConfLocalTextItem(193, "garden_evolve", "进化", "Evolve"));
		AddItem(new ConfLocalTextItem(194, "garden_tobattle", "出战", "Go to battle"));
		AddItem(new ConfLocalTextItem(195, "garden_eat", "吃下", "Eat"));
		AddItem(new ConfLocalTextItem(196, "garden_nobattle", "取消出战", "Cancel the battle"));
		AddItem(new ConfLocalTextItem(197, "battle_vocalconcert", "音乐会套装每秒对范围<color=#ff0000>{0}</color>造成<color=#ff0000>{1}</color>伤害", "The Concert Suit deals <color=#ff0000>{1}</color> damage to the area <color=#ff0000>{0}</color> every second."));
		AddItem(new ConfLocalTextItem(198, "pause_hud", "开启伤害显示", "Enable damage display"));
		AddItem(new ConfLocalTextItem(199, "pause_mainmenu", "主菜单", "Main Menu"));
		AddItem(new ConfLocalTextItem(200, "pause_return", "返回游戏", "Return Game"));
		AddItem(new ConfLocalTextItem(201, "pause_restart", "重新开始\r\n你想要重新开始游戏吗？\r\n你的存档将会删除", "Restart\r\nDo you want to restart the game? \r\nYour save data will be deleted"));
		AddItem(new ConfLocalTextItem(202, "pause_exit", "离开游戏？\r\n想要回到主菜单吗？\r\n你下一次开始游戏将从上一波商店页面开始", "Leave the game? \r\nWant to return to the main menu? \r\nThe next time you start the game, you will start from the last wave of store pages"));
		AddItem(new ConfLocalTextItem(203, "pause_exit2", "离开", "Exit"));
		AddItem(new ConfLocalTextItem(204, "victory_1", "恭喜你击败了\r\n僵王博士\r\n取得了最终的胜利", "Congratulations on defeating Dr. Zombie King and achieving the final victory."));
		AddItem(new ConfLocalTextItem(205, "property_MaximumHP_info", "最大生命值\n每波开始时生命值将为{0}</color>\n生命值变为0脑子会被僵尸吃掉", "Max HP\nHP will be {0} </color>at the beginning of each wave\nWhen HP reaches 0, the brain will be eaten by zombies"));
		AddItem(new ConfLocalTextItem(206, "property_LifeRecovery_info", "生命恢复\n每<color=#ff0000>10s</color>会恢复{0}</color>点生命值\n恢复能力高于受到的伤害时我将无敌", "HP Recovery\nHP will be restored to {0}</color> points every <color=#ff0000>10s</color>\nWhen the recovery ability is higher than the damage taken, I will be invincible"));
		AddItem(new ConfLocalTextItem(207, "property_Adrenaline_info", "肾上腺素\n每次攻击都让我热血澎湃\n每次攻击有{0}%概率恢复{1}点生命值</color>", "Adrenaline\nEvery attack makes my blood boil\nEach attack has a {0}% chance to recover + recoveryHp + HP points</color>"));
		AddItem(new ConfLocalTextItem(208, "property_Power_info", "力量\n平底锅造成的基础伤害增加{0}</color>\n击退的力量增加<color=#00ff00>{1}%</color>", "Power\nThe basic damage caused by the pan is increased by {0}</color>\nThe knockback Power is increased by <color=#00ff00> + value + %</color>"));
		AddItem(new ConfLocalTextItem(209, "property_PercentageDamage_info", "伤害\n平底锅造成的基础伤害增加{0}%</color>\n某些道具的伤害也会随百分比伤害增加", "Damage\nThe basic damage caused by the pan increases by {0}%</color>\nThe damage of some items will also increase with the percentage damage"));
		AddItem(new ConfLocalTextItem(210, "property_AttackSpeed_info", "攻击速度\n平底锅移动的速度增加{0}%</color>\n某些道具的也会受到攻击速度的影响，如木槌", "Attack speed\nThe speed of the pan's movement increases by {0}%</color>\nSome items are also affected by the attack speed, such as the mallet"));
		AddItem(new ConfLocalTextItem(211, "property_Range_info", "攻击范围\n眼睛更明亮，攻击范围和拾取范围增加{0}%</color>\n某些道具的也会受到攻击范围的影响，如演唱会套装", "Attack range\nThe eyes are brighter, and the attack range and pick range increases by {0}%</color>\nSome items are also affected by the attack range, such as the concert suit"));
		AddItem(new ConfLocalTextItem(212, "property_CriticalHitRate_info", "暴击率\n攻击有{0}%</color>造成1.5倍伤害", "Critical hit rate\nAttacks have {0}%</color> to cause 1.5 times the damage"));
		AddItem(new ConfLocalTextItem(213, "property_MoveSpeed_info", "移动速度\n基础移速增加{0}%</color>\n某些道具的也会受到攻击范围的影响，如小推车\n<color=#00ff00>跑步的速度为基础速度的1.5倍</color>", "Movement speed\nThe basic movement speed increases by {0}%</color>\nSome items are also affected by the attack range, such as the cart\n <color=#00ff00>Running speed is 1.5 times the base speed</color>"));
		AddItem(new ConfLocalTextItem(214, "property_Armor_info", "护甲|<color=#ff0000>上限90%</color>\n受到的伤害减少{0}%</color>\n能有效阻挡僵尸吃掉脑子", "Armor|<color=#ff0000>Upper limit 90%</color>\nReduces damage received by {0}%</color>\nCan effectively prevent zombies from eating brains"));
		AddItem(new ConfLocalTextItem(215, "property_Lucky_info", "幸运\n能够增加钱币掉落的概率及质量\n能够增加阳光掉落最大个数\n能够增大高级物品刷新概率\n这非常重要", "Lucky\nCan increase the probability and quality of coin drops\nCan increase the maximum number of sunlight drops\nCan increase the probability of high-level item refreshes\nThis is very important"));
		AddItem(new ConfLocalTextItem(216, "property_Sunshine_info", "阳光\n每波结束可以免费获得{0}</color>阳光", "Sunlight\nYou can get {0}</color>Sunlight for free at the end of each wave"));
		AddItem(new ConfLocalTextItem(217, "property_GoldCoins_info", "金币\n每波结束可以免费获得{0}</color>金币", "Gold\nYou can get {0}</color>Gold for free at the end of each wave"));
		AddItem(new ConfLocalTextItem(218, "property_Botany_info", "植物学\n可以使植物造成的伤害增加{0}%</color>", "Botany\nCan increase the damage caused by plants by {0}%</color>"));
		AddItem(new ConfLocalTextItem(219, "cultivation_plant1", " 培育", "Cultivation"));
		AddItem(new ConfLocalTextItem(220, "cultivation_plant2", " 基础伤害", "Basic damage"));
		AddItem(new ConfLocalTextItem(221, "cultivation_plant3", " 百分比伤害", "Percentage damage"));
		AddItem(new ConfLocalTextItem(222, "cultivation_plant4", " 攻击检测范围", "Attack detection range"));
		AddItem(new ConfLocalTextItem(223, "cultivation_plant5", " 攻击冷却", "Attack cooldown"));
		AddItem(new ConfLocalTextItem(224, "cultivation_plant6", " 子弹速度", "Bullet speed"));
		AddItem(new ConfLocalTextItem(225, "cultivation_plant7", " 溅射伤害", "Splash damage"));
		AddItem(new ConfLocalTextItem(226, "cultivation_plant8", " 消化速度", "Digestion speed"));
		AddItem(new ConfLocalTextItem(227, "cultivation_plant9", " 一次性吞噬个数", "Number of swallowed at one time"));
		AddItem(new ConfLocalTextItem(228, "cultivation_plant10", " 金币率转换", "Coin rate conversion"));
		AddItem(new ConfLocalTextItem(229, "cultivation_plant11", " 阳光率转换", "Sun rate conversion"));
		AddItem(new ConfLocalTextItem(230, "cultivation_plant12", " 穿透数量", "Number of penetrations"));
		AddItem(new ConfLocalTextItem(231, "cultivation_plant13", " 暴击伤害", "Critical damage"));
		AddItem(new ConfLocalTextItem(232, "cultivation_plant14", " 玩家攻击速度", "Player attack speed"));
		AddItem(new ConfLocalTextItem(233, "cultivation_plant15", " 风速", "Wind speed"));
		AddItem(new ConfLocalTextItem(234, "cultivation_plant16", " 逆风恢复", "Recovery against wind"));
		AddItem(new ConfLocalTextItem(235, "cultivation_plant17", " 僵尸风阻", "Zombie wind resistance"));
		AddItem(new ConfLocalTextItem(236, "cultivation_plant18", " 爆炸范围", "Explosion range"));
		AddItem(new ConfLocalTextItem(237, "cultivation_plant19", " 普通僵尸即死率", "Common zombie instant death rate"));
		AddItem(new ConfLocalTextItem(238, "cultivation_plant20", " 大型僵尸增伤", "Increased damage for large zombies"));
		AddItem(new ConfLocalTextItem(239, "cultivation_plant21", " 阳光减少", "Reduced sunlight"));
		AddItem(new ConfLocalTextItem(240, "cultivation_plant22", " 黄油概率", "Butter probability"));
		AddItem(new ConfLocalTextItem(241, "cultivation_plant23", " 控制时间", "Control time"));
		AddItem(new ConfLocalTextItem(242, "cultivation_plant24", " 暴击率", "Critical rate"));
		AddItem(new ConfLocalTextItem(243, "cultivation_plant25", " 伤害段数*2概率", "Damage segment number * 2 probability"));
		AddItem(new ConfLocalTextItem(244, "cultivation_plant26", " 吸取金币个数", "Number of gold coins absorbed"));
		AddItem(new ConfLocalTextItem(245, "cultivation_plant27", " 吸取持续时间", "Duration of absorption"));
		AddItem(new ConfLocalTextItem(246, "cultivation_plant28", " 吞噬墓碑概率", "Probability of swallowing tombstones"));
		AddItem(new ConfLocalTextItem(247, "cultivation_plant29", " 魅惑者可攻击次数", "Number of attacks that the charmer can make"));
		AddItem(new ConfLocalTextItem(248, "cultivation_plant30", " 连续触发概率", "Continuous trigger probability"));
		AddItem(new ConfLocalTextItem(249, "cultivation_plant31", " 换取金币", "Exchange for gold coins"));
		AddItem(new ConfLocalTextItem(250, "cultivation_plant32", " 吸取铁制品个数", "Number of iron products absorbed"));
		AddItem(new ConfLocalTextItem(251, "cultivation_plant33", " 掉落金币概率", "Probability of dropping gold coins"));
		AddItem(new ConfLocalTextItem(252, "cultivation_plant34", " 掉落钻石概率", "Probability of dropping diamonds"));
		AddItem(new ConfLocalTextItem(253, "cultivation_plant35", " 掉落双倍概率", "Probability of dropping double drops"));
		AddItem(new ConfLocalTextItem(254, "cultivation_plant36", " 范围攻速提升", "Range attack speed increase"));
		AddItem(new ConfLocalTextItem(255, "cultivation_plant37", " 范围生命恢复", "Range health recovery"));
		AddItem(new ConfLocalTextItem(256, "cultivation_plant38", " 范围伤害增加", "Range damage increase"));
		AddItem(new ConfLocalTextItem(257, "cultivation_plant39", " 子弹概率变多", "Bullet probability becomes more"));
		AddItem(new ConfLocalTextItem(258, "cultivation_plant40", " 子弹大小", "Bullet size"));
		AddItem(new ConfLocalTextItem(259, "cultivation_plant41", " 触发后生命值恢复比例", "Health value recovery ratio after triggering"));
		AddItem(new ConfLocalTextItem(260, "cultivation_plant42", " 攻击掉落南瓜概率", "Probability of dropping pumpkins when attacking"));
		AddItem(new ConfLocalTextItem(261, "cultivation_plant43", " 减速百分比", "Slowdown percentage"));
		AddItem(new ConfLocalTextItem(262, "cultivation_plant44", " 减速时间", "Slowdown time"));
		AddItem(new ConfLocalTextItem(263, "cultivation_plant45", " 破坏载具数量", "Number of vehicles destroyed"));
		AddItem(new ConfLocalTextItem(264, "cultivation_plant46", " 生成阳光质量", "Quality of sunlight generated"));
		AddItem(new ConfLocalTextItem(265, "cultivation_plant47", " 高坚果生命值（植物学）", "High Nut Health (Botany)"));
		AddItem(new ConfLocalTextItem(266, "cultivation_plant48", " 最终爆炸概率", "Final Explosion Chance"));
		AddItem(new ConfLocalTextItem(267, "cultivation_plant49", " 反伤伤害", "Retaliate Damage"));
		AddItem(new ConfLocalTextItem(268, "cultivation_plant50", " 反伤概率", "Retaliate Chance"));
		AddItem(new ConfLocalTextItem(269, "cultivation_plant51", " 豌豆增伤", "Pea Damage"));
		AddItem(new ConfLocalTextItem(270, "cultivation_plant52", " 豌豆溅射伤害", "Pea Splash Damage"));
		AddItem(new ConfLocalTextItem(271, "cultivation_plant53", " 豌豆速度", "Pea Speed"));
		AddItem(new ConfLocalTextItem(272, "cultivation_plant54", " 滚动速度", "Rolling Speed"));
		AddItem(new ConfLocalTextItem(273, "cultivation_plant55", " 爆炸坚果概率", "Exploding Nut Chance"));
		AddItem(new ConfLocalTextItem(274, "cultivation_plant56", " 冰冻时间", "Freeze Time"));
		AddItem(new ConfLocalTextItem(275, "cultivation_plant57", " 冰冻期间攻速增加", "Attack Speed ​​Increase During Freeze"));
		AddItem(new ConfLocalTextItem(276, "cultivation_plant58", " 出土时间", "Unearth Time"));
		AddItem(new ConfLocalTextItem(277, "cultivation_plant59", " 连坐概率", "Linked Nut Chance"));
		AddItem(new ConfLocalTextItem(278, "cultivation_plant60", " 玩家对僵尸增伤", "Player Damage Increased on Zombies"));
		AddItem(new ConfLocalTextItem(279, "cultivation_plant61", " 肾上腺素", "Adrenaline"));
		AddItem(new ConfLocalTextItem(280, "cultivation_plant62", " 生命恢复", "Health Regeneration"));
		AddItem(new ConfLocalTextItem(281, "cultivation_plant63", " 幸运", "Lucky"));
		AddItem(new ConfLocalTextItem(282, "cultivation_plant64", " 植物学", "Botany"));
		AddItem(new ConfLocalTextItem(283, "cultivation_plant65", " 范围", "Range"));
		AddItem(new ConfLocalTextItem(284, "cultivation_plant66", " 伤害", "Damage"));
		AddItem(new ConfLocalTextItem(285, "cultivation_plant67", " 攻击速度", "Attack Speed"));
		AddItem(new ConfLocalTextItem(286, "cultivation_plant68", " 移动速度", "Move Speed"));
		AddItem(new ConfLocalTextItem(287, "cultivation_plant69", " 力量", "Power"));
		AddItem(new ConfLocalTextItem(288, "cultivation_plant70", " 最大生命值", "Max Health"));
		AddItem(new ConfLocalTextItem(289, "cultivation_plant71", " 金币", "Gold"));
		AddItem(new ConfLocalTextItem(290, "cultivation_plant72", " 护甲", "Armor"));
		AddItem(new ConfLocalTextItem(291, "cultivation_plant73", " 阳光", "Sunlight"));
		AddItem(new ConfLocalTextItem(292, "mainmenu_grow", "祭坛", "altar"));
		AddItem(new ConfLocalTextItem(293, "mainmenu_reduction", "还原", "Reduction"));
		AddItem(new ConfLocalTextItem(294, "mainmenu_growTitle", "强 化 目 录", "Strengthen the directory"));
		AddItem(new ConfLocalTextItem(295, "mainmenu_strengthen", "强化", "Strengthen"));
		AddItem(new ConfLocalTextItem(296, "mainmenu_levelmax", "已满级", "Full level"));
		AddItem(new ConfLocalTextItem(297, "mainmenu_grow1", "强化增加{0}最大生命值，当前等级{1},总共增加生命值{2}。", "Enhance increases maximum health by {0}, current level {1}, total health increase by {2}."));
		AddItem(new ConfLocalTextItem(298, "mainmenu_grow2", "强化增加{0}生命恢复，当前等级{1},总共增加生命恢复{2}。生命恢复会随时间增加当前生命值", "Enhance increases health regeneration by {0}, current level {1}, total health regeneration by {2}. Health regeneration increases current health over time"));
		AddItem(new ConfLocalTextItem(299, "mainmenu_grow3", "强化增加{0}肾上腺素，当前等级{1},总共增加肾上腺素{2}。肾上腺素使攻击有概率恢复生命值", "Enhance increases adrenaline by {0}, current level {1}, total adrenaline increase by {2}. Adrenaline gives attacks a chance to restore health"));
		AddItem(new ConfLocalTextItem(300, "mainmenu_grow4", "强化增加{0}力量，当前等级{1},总共增加力量{2}。增加攻击的基础伤害", "Enhance increases strength by {0}, current level {1}, total strength increase by {2}. Increases base damage of attacks"));
		AddItem(new ConfLocalTextItem(301, "mainmenu_grow5", "强化增加{0}%伤害，当前等级{1},总共增加伤害{2}%。增加攻击百分比伤害", "Enhancement increases damage by {0}%; current level {1}, total increased damage by {2}%. Increases attack percentage damage"));
		AddItem(new ConfLocalTextItem(302, "mainmenu_grow6", "强化增加{0}%攻击速度，当前等级{1},总共增加攻击速度{2}%。减少攻击冷却", "Enhancement increases attack speed by {0}%; current level {1}, total increased attack speed by {2}%. Reduces attack cooldown"));
		AddItem(new ConfLocalTextItem(303, "mainmenu_grow7", "强化增加{0}%范围，当前等级{1},总共增加范围{2}%。增加攻击范围和拾取范围", "Enhancement increases range by {0}%; current level {1}, total increased range by {2}%. Increases attack range and pickup range"));
		AddItem(new ConfLocalTextItem(304, "mainmenu_grow8", "强化增加{0}%暴击率，当前等级{1},总共增加暴击率{2}%。攻击有概率造成更多伤害", "Enhancement increases critical hit rate by {0}%; current level {1}, total increased critical hit rate by {2}%. Attacks have a chance to cause more damage"));
		AddItem(new ConfLocalTextItem(305, "mainmenu_grow9", "强化增加{0}%移动速度，当前等级{1},总共增加移动速度{2}%。移动会更快", "Enhancement increases movement speed by {0}%; current level {1}, total increased movement speed by {2}%. Moves faster"));
		AddItem(new ConfLocalTextItem(306, "mainmenu_grow10", "强化增加{0}护甲，当前等级{1},总共增加护甲{2}。减少收到的伤害", "Enhance increases {0} armor, current level {1}, total increase in armor {2}. Reduce damage received"));
		AddItem(new ConfLocalTextItem(307, "mainmenu_grow11", "强化增加{0}幸运，当前等级{1},总共增加幸运{2}。增加钱币，阳光掉落概率，稀有物品刷新概率", "Enhance increases {0} luck, current level {1}, total increase in luck {2}. Increases coin, sunlight drop probability, rare item refresh probability"));
		AddItem(new ConfLocalTextItem(308, "mainmenu_grow12", "强化增加{0}阳光，当前等级{1},总共增加阳光{2}。波次结束增加阳光", "Enhance increases {0} sunlight, current level {1}, total increase in sunlight {2}. Increase sunlight at the end of the wave"));
		AddItem(new ConfLocalTextItem(309, "mainmenu_grow13", "强化增加{0}金币，当前等级{1},总共增加金币{2}。波次结束增加金币", "Enhance increases {0} gold coins, current level {1}, total increase in gold coins {2}. Increase gold coins at the end of the wave"));
		AddItem(new ConfLocalTextItem(310, "mainmenu_grow14", "强化增加{0}植物学，当前等级{1},总共增加植物学{2}。额外增加植物攻击百分比伤害", "Enhance increases {0} botany, current level {1}, total increase in botany {2}. Additional percentage damage of plant attacks"));
		AddItem(new ConfLocalTextItem(311, "grow_slotNum", "增加卡槽", "Add card slot"));
		AddItem(new ConfLocalTextItem(312, "mainmenu_grow15", "增加{0}个卡槽，当前等级{1}，总共增加卡槽数量{2}。卡槽数量决定植物出战数量", "Add {0} card slots, current level {1}, total card slots added {2}. The number of card slots determines the number of plants that can be used in battle"));
		AddItem(new ConfLocalTextItem(313, "mainmenu_grow16_0", "强化后可携带一个普通品质道具开局", "After strengthening, you can start with a normal quality item"));
		AddItem(new ConfLocalTextItem(314, "mainmenu_grow16_1", "强化后可携带一个蓝色品质道具开局，当前可携带普通品质", "After strengthening, you can start with a blue quality item, and currently you can carry a normal quality item"));
		AddItem(new ConfLocalTextItem(315, "mainmenu_grow16_2", "强化后可携带一个紫色品质道具开局，当前可携带蓝色品质", "After strengthening, you can start with a purple quality item, and currently you can carry a blue quality item"));
		AddItem(new ConfLocalTextItem(316, "mainmenu_grow16_3", "可携带一个紫色品质道具开局", "You can start with a purple quality item"));
		AddItem(new ConfLocalTextItem(317, "grow_addProp", "遗产", "Heritage"));
		AddItem(new ConfLocalTextItem(318, "mainmenu_grow17_0", "强化后可以让一只价值较低的植物协同作战", "After strengthening, it can make a plant of lower value cooperate in combat"));
		AddItem(new ConfLocalTextItem(319, "mainmenu_grow17_1", "强化后可以让一只价值中等的植物协同作战，当前可与价值较低的植物协调作战", "After strengthening, it can make a plant of medium value cooperate in combat, and currently can coordinate with plants of lower value"));
		AddItem(new ConfLocalTextItem(320, "mainmenu_grow17_2", "强化后可以让一只价值较高的植物协同作战，当前可与价值中等的植物协调作战", "After strengthening, it can make a plant of higher value cooperate in combat, and currently can coordinate with plants of medium value"));
		AddItem(new ConfLocalTextItem(321, "mainmenu_grow17_3", "强化后可以让两只价值较高的植物协同作战，当前可与一只高价值的植物协调作战", "After strengthening, it can make two plants of higher value cooperate in combat, and currently can coordinate with a plant of high value"));
		AddItem(new ConfLocalTextItem(322, "mainmenu_grow17_4", "可以让两只价值较高的植物协同作战", "It can make two plants of higher value cooperate in combat"));
		AddItem(new ConfLocalTextItem(323, "grow_addPlant", "植物学家", "Botanist"));
		AddItem(new ConfLocalTextItem(324, "mainmenu_grow18", "强化增加初始携带{0}阳光，当前等级{1},总共携带阳光{2}。可以开局携带阳光", "Strengthening increases the initial carrying capacity of {0} sunlight, current level {1}, total carrying capacity of {2} sunlight. You can start with sunlight"));
		AddItem(new ConfLocalTextItem(325, "mainmenu_grow19", "强化增加初始携带{0}金币，当前等级{1},总共携带金币{2}。可以开局携带金币", "Strengthening increases the initial carrying capacity of {0} gold coins, current level {1}, total carrying capacity of {2} gold coins. You can start with gold coins"));
		AddItem(new ConfLocalTextItem(326, "grow_addSun", "光合作用", "Photosynthesis"));
		AddItem(new ConfLocalTextItem(327, "grow_addMoney", "钱袋子", "Money bag"));
		AddItem(new ConfLocalTextItem(328, "grow_resurrection", "钛合金脑", "Titanium Alloy Brain"));
		AddItem(new ConfLocalTextItem(329, "mainmenu_grow20", "强化增加{0}次免疫死亡次数，当前等级{1},总共能免疫死亡{2}次。生命值归零后可以免疫伤害并恢复一半生命值", "Enhancement increases the number of immune deaths by {0} times. The current level is {1}, and the total number of immune deaths is {2}. After the health value reaches zero, it can be immune to damage and recover half of the health value."));
		AddItem(new ConfLocalTextItem(330, "grow_text", "复活", "Resurrection"));
		AddItem(new ConfLocalTextItem(331, "grow_curse", "诅咒", "Curse"));
		AddItem(new ConfLocalTextItem(332, "mainmenu_grow21", "强化增加{0}%僵尸数量，当前等级{1},总共增加{2}%僵尸数量。", "Enhanced: Increases the number of zombies by {0}%, current level {1}, total increase of zombies by {2}%."));
		AddItem(new ConfLocalTextItem(333, "grow_physicalRecovery", "体力恢复", "Stamina Recovery"));
		AddItem(new ConfLocalTextItem(334, "mainmenu_grow22", "强化增加{0}%奔跑的体力恢复速率，当前等级{1},总共增加{2}%体力恢复速率。", "Enhanced: Increases the speed of physical recovery while running by {0}%, current level {1}, total increase of physical recovery by {2}%."));
		AddItem(new ConfLocalTextItem(335, "grow_runTime", "体力", "Stamina"));
		AddItem(new ConfLocalTextItem(336, "mainmenu_grow23", "强化增加{0}秒奔跑的体力，当前等级{1},总共增加{2}秒奔跑体力。", "Enhanced to increase running stamina by {0} seconds, current level {1}, total increase of running stamina by {2} seconds."));
		AddItem(new ConfLocalTextItem(337, "grow_dashTime", "翻滚", "Rolling"));
		AddItem(new ConfLocalTextItem(338, "grow_dashRecovery", "翻滚体力", "Rolling Stamina"));
		AddItem(new ConfLocalTextItem(339, "mainmenu_grow24", "强化增加{0}翻滚次数，当前等级{1},总共增加{2}翻滚次数。灵活的翻滚能躲避僵尸的攻击。", "Enhanced: Increases the number of rolls by {0}, current level {1}, total increase of {2} rolls. Flexible rolling can dodge zombie attacks."));
		AddItem(new ConfLocalTextItem(340, "mainmenu_grow25", "强化增加{0}%翻滚的体力恢复速率，当前等级{1},总共增加{2}%翻滚体力恢复速率。", "Enhanced: Increases the stamina recovery rate of rolling by {0}%, current level {1}, total increase of {2}% stamina recovery rate of rolling."));
		AddItem(new ConfLocalTextItem(341, "achievement_title1", "初见僵潮", "First encounter with zombies"));
		AddItem(new ConfLocalTextItem(342, "achievement_title2", "战利品？", "Loot?"));
		AddItem(new ConfLocalTextItem(343, "achievement_title3", "收割者", "Harvester"));
		AddItem(new ConfLocalTextItem(344, "achievement_title4", "捕猎者", "Hunter"));
		AddItem(new ConfLocalTextItem(345, "achievement_title5", "小试牛刀", "Testing"));
		AddItem(new ConfLocalTextItem(346, "achievement_title6", "融会贯通", "Mastering"));
		AddItem(new ConfLocalTextItem(347, "achievement_title7", "出神入化", "Mastering"));
		AddItem(new ConfLocalTextItem(348, "achievement_title8", "头好痒", "Itchy head"));
		AddItem(new ConfLocalTextItem(349, "achievement_title9", "双发豌豆", "Double-shot peas"));
		AddItem(new ConfLocalTextItem(350, "achievement_title10", "加特林豌豆", "Gatling peas"));
		AddItem(new ConfLocalTextItem(351, "achievement_title11", "玉米加农炮", "Corn cannon"));
		AddItem(new ConfLocalTextItem(352, "achievement_title12", "香蒲", "Cattail"));
		AddItem(new ConfLocalTextItem(353, "achievement_title13", "忧郁菇", "Depression mushrooms"));
		AddItem(new ConfLocalTextItem(354, "achievement_title14", "双子向日葵", "Twin sunflowers"));
		AddItem(new ConfLocalTextItem(355, "achievement_title15", "地刺王", "Earth thorn king"));
		AddItem(new ConfLocalTextItem(356, "achievement_title16", "毁灭菇", "Destruction mushrooms"));
		AddItem(new ConfLocalTextItem(357, "achievement_title17", "篮球", "Basketball"));
		AddItem(new ConfLocalTextItem(358, "achievement_title18", "铁桶", "Barrels"));
		AddItem(new ConfLocalTextItem(359, "achievement_title19", "橄榄球头盔", "Football helmets"));
		AddItem(new ConfLocalTextItem(360, "achievement_title20", "路牌", "Signboards"));
		AddItem(new ConfLocalTextItem(361, "achievement_title21", "报纸", "Newspapers"));
		AddItem(new ConfLocalTextItem(362, "achievement_title22", "路障", "Roadblocks"));
		AddItem(new ConfLocalTextItem(363, "achievement_title23", "铁栅栏", "Iron fences"));
		AddItem(new ConfLocalTextItem(364, "achievement_title24", "轮胎", "Zamboni"));
		AddItem(new ConfLocalTextItem(365, "achievement_title25", "冰碎", "Ice shatters"));
		AddItem(new ConfLocalTextItem(366, "achievement_title26", "火焰", "Flames"));
		AddItem(new ConfLocalTextItem(367, "achievement_title27", "买买买", "Buy, buy, buy"));
		AddItem(new ConfLocalTextItem(368, "achievement_title28", "大力士", "Hercules"));
		AddItem(new ConfLocalTextItem(369, "achievement_title29", "传哪来了", "Where did it come from"));
		AddItem(new ConfLocalTextItem(370, "achievement_title30", "无坚不摧", "Indestructible"));
		AddItem(new ConfLocalTextItem(371, "achievement_title31", "强身健体", "Strengthening the body"));
		AddItem(new ConfLocalTextItem(372, "achievement_title32", "唯快不破", "Only speed can break through"));
		AddItem(new ConfLocalTextItem(373, "achievement_title33", "钢铁壁垒", "Iron barrier"));
		AddItem(new ConfLocalTextItem(374, "achievement_title34", "植物学家", "Botanist"));
		AddItem(new ConfLocalTextItem(375, "achievement_title35", "腰缠万贯", "Wealthy"));
		AddItem(new ConfLocalTextItem(376, "achievement_title36", "热爱园艺", "Love gardening"));
		AddItem(new ConfLocalTextItem(377, "achievement_title37", "吉人天相", "Lucky people"));
		AddItem(new ConfLocalTextItem(378, "achievement_title38", "厚积薄发", "Solid accumulation"));
		AddItem(new ConfLocalTextItem(379, "achievement_info1", "第一次开始冒险", "First adventure"));
		AddItem(new ConfLocalTextItem(380, "achievement_info2", "总共收集300个僵尸头", "Collect 30 in total 0 zombie heads"));
		AddItem(new ConfLocalTextItem(381, "achievement_info3", "总共收集2000个僵尸头", "Collected 2,000 zombie heads in total"));
		AddItem(new ConfLocalTextItem(382, "achievement_info4", "总共收集10000个僵尸头", "Collected 10,000 zombie heads in total"));
		AddItem(new ConfLocalTextItem(383, "achievement_info5", "一局冒险中收集100个僵尸头", "Collected 100 zombie heads in one adventure"));
		AddItem(new ConfLocalTextItem(384, "achievement_info6", "一局冒险中收集500个僵尸头", "Collected 500 zombie heads in one adventure"));
		AddItem(new ConfLocalTextItem(385, "achievement_info7", "一局冒险中收集1000个僵尸头", "Collected 1000 zombie heads in one adventure"));
		AddItem(new ConfLocalTextItem(386, "achievement_info8", "首次被僵尸吃掉脑子", "First time having your brain eaten by a zombie"));
		AddItem(new ConfLocalTextItem(387, "achievement_info9", "累计培养4次豌豆射手", "Cultivated 4 times of pea shooters"));
		AddItem(new ConfLocalTextItem(388, "achievement_info10", "累计进化过2次双发射手", "Cultivated 2 times of dual shooters"));
		AddItem(new ConfLocalTextItem(389, "achievement_info11", "累计培养4次玉米投手", "Cultivated 4 times of corn pitchers"));
		AddItem(new ConfLocalTextItem(390, "achievement_info12", "第一次购买水花盆", "Buyed a water flower pot for the first time"));
		AddItem(new ConfLocalTextItem(391, "achievement_info13", "累计培养4次大喷菇", "Cultivated 4 times of giant mushrooms"));
		AddItem(new ConfLocalTextItem(392, "achievement_info14", "累计培养4次向日葵", "Cultivated 4 times of sunflowers"));
		AddItem(new ConfLocalTextItem(393, "achievement_info15", "累计培养4次地刺", "Cultivated 4 times of ground spikes"));
		AddItem(new ConfLocalTextItem(394, "achievement_info16", "累计使用灰烬植物击杀10只僵尸", "Killed 10 enemies with ash plants Zombies"));
		AddItem(new ConfLocalTextItem(395, "achievement_info17", "首次击杀投篮僵尸", "Killed a basketball zombie for the first time"));
		AddItem(new ConfLocalTextItem(396, "achievement_info18", "首次击杀铁桶僵尸", "Killed a barrel zombie for the first time"));
		AddItem(new ConfLocalTextItem(397, "achievement_info19", "首次击杀橄榄球僵尸", "Killed a football zombie for the first time"));
		AddItem(new ConfLocalTextItem(398, "achievement_info20", "首次击杀巨人僵尸", "Killed a giant zombie for the first time"));
		AddItem(new ConfLocalTextItem(399, "achievement_info21", "首次击杀读报僵尸", "Killed a newspaper zombie for the first time"));
		AddItem(new ConfLocalTextItem(400, "achievement_info22", "首次击杀路障僵尸", "Killed a roadblock zombie for the first time"));
		AddItem(new ConfLocalTextItem(401, "achievement_info23", "首次击杀铁栅栏僵尸", "Killed a fence zombie for the first time"));
		AddItem(new ConfLocalTextItem(402, "achievement_info24", "首次击杀冰车僵尸", "Kill the Ice Truck Zombie for the first time"));
		AddItem(new ConfLocalTextItem(403, "achievement_info25", "首次使用寒冰菇", "Used ice mushrooms for the first time"));
		AddItem(new ConfLocalTextItem(404, "achievement_info26", "首次使用火爆辣椒", "Used flaming peppers for the first time"));
		AddItem(new ConfLocalTextItem(405, "achievement_info27", "首次购物", "First purchase"));
		AddItem(new ConfLocalTextItem(406, "achievement_info28", "使用菠菜的飞头攻击累计击杀10只僵尸", "Killed 10 zombies with Spinach's flying head attack"));
		AddItem(new ConfLocalTextItem(407, "achievement_info29", "首次使用传送门", "Used a portal for the first time"));
		AddItem(new ConfLocalTextItem(408, "achievement_info30", "力量达到20", "Strength reached 20"));
		AddItem(new ConfLocalTextItem(409, "achievement_info31", "生命值达到100", "Health reached 100"));
		AddItem(new ConfLocalTextItem(410, "achievement_info32", "攻击速度达到50", "Attack speed reached 50"));
		AddItem(new ConfLocalTextItem(411, "achievement_info33", "护甲达到50", "Armor reached 50"));
		AddItem(new ConfLocalTextItem(412, "achievement_info34", "植物学达到100", "Botany reached 100"));
		AddItem(new ConfLocalTextItem(413, "achievement_info35", "金币达到100", "Gold reached to 100"));
		AddItem(new ConfLocalTextItem(414, "achievement_info36", "阳光达到500", "Sunshine reaches 500"));
		AddItem(new ConfLocalTextItem(415, "achievement_info37", "幸运达到25", "Luck reaches 25"));
		AddItem(new ConfLocalTextItem(416, "achievement_info38", "祭坛等级全部升满", "Altar levels are fully upgraded"));
		AddItem(new ConfLocalTextItem(417, "achievement_lock1", "", ""));
		AddItem(new ConfLocalTextItem(418, "achievement_lock2", "", ""));
		AddItem(new ConfLocalTextItem(419, "achievement_lock3", "", ""));
		AddItem(new ConfLocalTextItem(420, "achievement_lock4", "", ""));
		AddItem(new ConfLocalTextItem(421, "achievement_lock5", "", ""));
		AddItem(new ConfLocalTextItem(422, "achievement_lock6", "", ""));
		AddItem(new ConfLocalTextItem(423, "achievement_lock7", "", ""));
		AddItem(new ConfLocalTextItem(424, "achievement_lock8", "", ""));
		AddItem(new ConfLocalTextItem(425, "achievement_lock9", "解锁双发豌豆", "Unlock Twin Peas"));
		AddItem(new ConfLocalTextItem(426, "achievement_lock10", "解锁加特林豌豆", "Unlock Gatling Peas"));
		AddItem(new ConfLocalTextItem(427, "achievement_lock11", "解锁玉米加农炮", "Unlock Corn Cannon"));
		AddItem(new ConfLocalTextItem(428, "achievement_lock12", "解锁香蒲", "Unlock Cattails"));
		AddItem(new ConfLocalTextItem(429, "achievement_lock13", "解锁忧郁菇", "Unlock Melancholy Mushrooms"));
		AddItem(new ConfLocalTextItem(430, "achievement_lock14", "解锁双子向日葵", "Unlock Twin Sunflowers"));
		AddItem(new ConfLocalTextItem(431, "achievement_lock15", "解锁地刺王", "Unlock Thorn King"));
		AddItem(new ConfLocalTextItem(432, "achievement_lock16", "解锁毁灭菇", "Unlock Destruction Mushrooms"));
		AddItem(new ConfLocalTextItem(433, "achievement_lock17", "解锁道具篮球", "Unlock Prop Basketballs"));
		AddItem(new ConfLocalTextItem(434, "achievement_lock18", "解锁道具铁桶", "Unlock Prop Barrels"));
		AddItem(new ConfLocalTextItem(435, "achievement_lock19", "解锁道具橄榄球头盔", "Unlock Prop Football Helmets"));
		AddItem(new ConfLocalTextItem(436, "achievement_lock20", "解锁道具路牌", "Unlock Prop Signs"));
		AddItem(new ConfLocalTextItem(437, "achievement_lock21", "解锁道具报纸", "Unlock Prop Newspapers"));
		AddItem(new ConfLocalTextItem(438, "achievement_lock22", "解锁道具路障", "Unlock Prop Roadblocks"));
		AddItem(new ConfLocalTextItem(439, "achievement_lock23", "解锁道具铁栅栏", "Unlock Prop Fences"));
		AddItem(new ConfLocalTextItem(440, "achievement_lock24", "解锁道具扶梯", "Unlock Prop Escalators"));
		AddItem(new ConfLocalTextItem(441, "achievement_lock25", "解锁道具冰碎", "Unlock Prop Ice Crusher"));
		AddItem(new ConfLocalTextItem(442, "achievement_lock26", "解锁道具火焰", "Unlock Prop Flames"));
		AddItem(new ConfLocalTextItem(443, "achievement_lock27", "解锁道具车钥匙", "Unlock Prop Car Keys"));
		AddItem(new ConfLocalTextItem(444, "achievement_lock28", "", ""));
		AddItem(new ConfLocalTextItem(445, "achievement_lock29", "", ""));
		AddItem(new ConfLocalTextItem(446, "achievement_lock30", "", ""));
		AddItem(new ConfLocalTextItem(447, "achievement_lock31", "", ""));
		AddItem(new ConfLocalTextItem(448, "achievement_lock32", "", ""));
		AddItem(new ConfLocalTextItem(449, "achievement_lock33", "", ""));
		AddItem(new ConfLocalTextItem(450, "achievement_lock34", "", ""));
		AddItem(new ConfLocalTextItem(451, "achievement_lock35", "", ""));
		AddItem(new ConfLocalTextItem(452, "achievement_lock36", "", ""));
		AddItem(new ConfLocalTextItem(453, "achievement_lock37", "", ""));
		AddItem(new ConfLocalTextItem(454, "achievement_lock38", "", ""));
	}
