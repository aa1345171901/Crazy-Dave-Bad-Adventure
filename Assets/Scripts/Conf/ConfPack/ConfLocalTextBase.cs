...
public class ConfLocalTextBase : ConfBase<ConfLocalTextItem>
{
	...
	private void Init1()
	{
		...
		AddItem(new ConfLocalTextItem(280, "cultivation_plant63", " 幸运", "Luck"));
		...
		AddItem(new ConfLocalTextItem(286, "cultivation_plant69", " 力量", "Strength"));
