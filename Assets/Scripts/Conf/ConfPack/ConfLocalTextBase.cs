...
public class ConfLocalTextBase : ConfBase<ConfLocalTextItem>
{
	...
	private void Init1()
	{
		...
		AddItem(new ConfLocalTextItem(340, "achievement_title1", "初见僵潮", "First encounter with zombies"));
		AddItem(new ConfLocalTextItem(341, "achievement_title2", "战利品？", "Loot?"));
		AddItem(new ConfLocalTextItem(342, "achievement_title3", "收割者", "Harvester"));
		AddItem(new ConfLocalTextItem(343, "achievement_title4", "捕猎者", "Hunter"));
		AddItem(new ConfLocalTextItem(344, "achievement_title5", "小试牛刀", "Testing"));
		AddItem(new ConfLocalTextItem(345, "achievement_title6", "融会贯通", "Mastering"));
		AddItem(new ConfLocalTextItem(346, "achievement_title7", "出神入化", "Mastering"));
		AddItem(new ConfLocalTextItem(347, "achievement_title8", "头好痒", "Itchy head"));
		AddItem(new ConfLocalTextItem(348, "achievement_title9", "双发豌豆", "Double-shot peas"));
		AddItem(new ConfLocalTextItem(349, "achievement_title10", "加特林豌豆", "Gatling peas"));
		AddItem(new ConfLocalTextItem(350, "achievement_title11", "玉米加农炮", "Corn cannon"));
		AddItem(new ConfLocalTextItem(351, "achievement_title12", "香蒲", "Cattail"));
		AddItem(new ConfLocalTextItem(352, "achievement_title13", "忧郁菇", "Depression mushrooms"));
		AddItem(new ConfLocalTextItem(353, "achievement_title14", "双子向日葵", "Twin sunflowers"));
		AddItem(new ConfLocalTextItem(354, "achievement_title15", "地刺王", "Earth thorn king"));
		AddItem(new ConfLocalTextItem(355, "achievement_title16", "毁灭菇", "Destruction mushrooms"));
		AddItem(new ConfLocalTextItem(356, "achievement_title17", "篮球", "Basketball"));
		AddItem(new ConfLocalTextItem(357, "achievement_title18", "铁桶", "Barrels"));
		AddItem(new ConfLocalTextItem(358, "achievement_title19", "橄榄球头盔", "Football helmets"));
		AddItem(new ConfLocalTextItem(359, "achievement_title20", "路牌", "Signboards"));
		AddItem(new ConfLocalTextItem(360, "achievement_title21", "报纸", "Newspapers"));
		AddItem(new ConfLocalTextItem(361, "achievement_title22", "路障", "Roadblocks"));
		AddItem(new ConfLocalTextItem(362, "achievement_title23", "铁栅栏", "Iron fences"));
		AddItem(new ConfLocalTextItem(363, "achievement_title24", "扶梯", "Escalators"));
		AddItem(new ConfLocalTextItem(364, "achievement_title25", "冰碎", "Ice shatters"));
		AddItem(new ConfLocalTextItem(365, "achievement_title26", "火焰", "Flames"));
		AddItem(new ConfLocalTextItem(366, "achievement_title27", "买买买", "Buy, buy, buy"));
		AddItem(new ConfLocalTextItem(367, "achievement_title28", "大力士", "Hercules"));
		AddItem(new ConfLocalTextItem(368, "achievement_title29", "传哪来了", "Where did it come from"));
		AddItem(new ConfLocalTextItem(369, "achievement_title30", "无坚不摧", "Indestructible"));
		AddItem(new ConfLocalTextItem(370, "achievement_title31", "强身健体", "Strengthening the body"));
		AddItem(new ConfLocalTextItem(371, "achievement_title32", "唯快不破", "Only speed can break through"));
		AddItem(new ConfLocalTextItem(372, "achievement_title33", "钢铁壁垒", "Iron barrier"));
		AddItem(new ConfLocalTextItem(373, "achievement_title34", "植物学家", "Botanist"));
		AddItem(new ConfLocalTextItem(374, "achievement_title35", "腰缠万贯", "Wealthy"));
		AddItem(new ConfLocalTextItem(375, "achievement_title36", "热爱园艺", "Love gardening"));
		AddItem(new ConfLocalTextItem(376, "achievement_title37", "吉人天相", "Lucky people"));
		AddItem(new ConfLocalTextItem(377, "achievement_title38", "厚积薄发", "Solid accumulation"));
		AddItem(new ConfLocalTextItem(378, "achievement_info1", "第一次开始冒险", "First adventure"));
		AddItem(new ConfLocalTextItem(379, "achievement_info2", "总共收集300个僵尸头", "Collect 30 in total 0 zombie heads"));
		AddItem(new ConfLocalTextItem(380, "achievement_info3", "总共收集2000个僵尸头", "Collected 2,000 zombie heads in total"));
		AddItem(new ConfLocalTextItem(381, "achievement_info4", "总共收集10000个僵尸头", "Collected 10,000 zombie heads in total"));
		AddItem(new ConfLocalTextItem(382, "achievement_info5", "一局冒险中收集50个僵尸头", "Collected 50 zombie heads in one adventure"));
		AddItem(new ConfLocalTextItem(383, "achievement_info6", "一局冒险中收集200个僵尸头", "Collected 200 zombie heads in one adventure"));
		AddItem(new ConfLocalTextItem(384, "achievement_info7", "一局冒险中收集500个僵尸头", "Collected 500 zombie heads in one adventure"));
		AddItem(new ConfLocalTextItem(385, "achievement_info8", "首次被僵尸吃掉脑子", "First time having your brain eaten by a zombie"));
		AddItem(new ConfLocalTextItem(386, "achievement_info9", "累计培养4次豌豆射手", "Cultivated 4 times of pea shooters"));
		AddItem(new ConfLocalTextItem(387, "achievement_info10", "累计进化过2次双发射手", "Cultivated 2 times of dual shooters"));
		AddItem(new ConfLocalTextItem(388, "achievement_info11", "累计培养2次玉米投手", "Cultivated 2 times of corn pitchers"));
		AddItem(new ConfLocalTextItem(389, "achievement_info12", "第一次购买水花盆", "Buyed a water flower pot for the first time"));
		AddItem(new ConfLocalTextItem(390, "achievement_info13", "累计培养2次大喷菇", "Cultivated 2 times of giant mushrooms"));
		AddItem(new ConfLocalTextItem(391, "achievement_info14", "累计培养2次向日葵", "Cultivated 2 times of sunflowers"));
		AddItem(new ConfLocalTextItem(392, "achievement_info15", "累计培养2次地刺", "Cultivated 2 times of ground spikes"));
		AddItem(new ConfLocalTextItem(393, "achievement_info16", "累计使用灰烬植物击杀10只僵尸", "Killed 10 enemies with ash plants Zombies"));
		AddItem(new ConfLocalTextItem(394, "achievement_info17", "首次击杀投篮僵尸", "Killed a basketball zombie for the first time"));
		AddItem(new ConfLocalTextItem(395, "achievement_info18", "首次击杀铁桶僵尸", "Killed a barrel zombie for the first time"));
		AddItem(new ConfLocalTextItem(396, "achievement_info19", "首次击杀橄榄球僵尸", "Killed a football zombie for the first time"));
		AddItem(new ConfLocalTextItem(397, "achievement_info20", "首次击杀巨人僵尸", "Killed a giant zombie for the first time"));
		AddItem(new ConfLocalTextItem(398, "achievement_info21", "首次击杀读报僵尸", "Killed a newspaper zombie for the first time"));
		AddItem(new ConfLocalTextItem(399, "achievement_info22", "首次击杀路障僵尸", "Killed a roadblock zombie for the first time"));
		AddItem(new ConfLocalTextItem(400, "achievement_info23", "首次击杀铁栅栏僵尸", "Killed a fence zombie for the first time"));
		AddItem(new ConfLocalTextItem(401, "achievement_info24", "首次击杀扶梯僵尸", "Killed an escalator zombie for the first time"));
		AddItem(new ConfLocalTextItem(402, "achievement_info25", "首次使用寒冰菇", "Used ice mushrooms for the first time"));
		AddItem(new ConfLocalTextItem(403, "achievement_info26", "首次使用火爆辣椒", "Used flaming peppers for the first time"));
		AddItem(new ConfLocalTextItem(404, "achievement_info27", "首次购物", "First purchase"));
		AddItem(new ConfLocalTextItem(405, "achievement_info28", "使用菠菜的飞头攻击累计击杀10只僵尸", "Killed 10 zombies with Spinach's flying head attack"));
		AddItem(new ConfLocalTextItem(406, "achievement_info29", "首次使用传送门", "Used a portal for the first time"));
		AddItem(new ConfLocalTextItem(407, "achievement_info30", "力量达到20", "Strength reached 20"));
		AddItem(new ConfLocalTextItem(408, "achievement_info31", "生命值达到100", "Health reached 100"));
		AddItem(new ConfLocalTextItem(409, "achievement_info32", "攻击速度达到50", "Attack speed reached 50"));
		AddItem(new ConfLocalTextItem(410, "achievement_info33", "护甲达到50", "Armor reached 50"));
		AddItem(new ConfLocalTextItem(411, "achievement_info34", "植物学达到100", "Botany reached 100"));
		AddItem(new ConfLocalTextItem(412, "achievement_info35", "金币达到100", "Gold reached to 100"));
		AddItem(new ConfLocalTextItem(413, "achievement_info36", "阳光达到500", "Sunshine reaches 500"));
		AddItem(new ConfLocalTextItem(414, "achievement_info37", "幸运达到25", "Luck reaches 25"));
		AddItem(new ConfLocalTextItem(415, "achievement_info38", "祭坛等级全部升满", "Altar levels are fully upgraded"));
		AddItem(new ConfLocalTextItem(416, "achievement_lock1", "", ""));
		AddItem(new ConfLocalTextItem(417, "achievement_lock2", "", ""));
		AddItem(new ConfLocalTextItem(418, "achievement_lock3", "", ""));
		AddItem(new ConfLocalTextItem(419, "achievement_lock4", "", ""));
		AddItem(new ConfLocalTextItem(420, "achievement_lock5", "", ""));
		AddItem(new ConfLocalTextItem(421, "achievement_lock6", "", ""));
		AddItem(new ConfLocalTextItem(422, "achievement_lock7", "", ""));
		AddItem(new ConfLocalTextItem(423, "achievement_lock8", "", ""));
		AddItem(new ConfLocalTextItem(424, "achievement_lock9", "解锁双发豌豆", "Unlock Twin Peas"));
		AddItem(new ConfLocalTextItem(425, "achievement_lock10", "解锁加特林豌豆", "Unlock Gatling Peas"));
		AddItem(new ConfLocalTextItem(426, "achievement_lock11", "解锁玉米加农炮", "Unlock Corn Cannon"));
		AddItem(new ConfLocalTextItem(427, "achievement_lock12", "解锁香蒲", "Unlock Cattails"));
		AddItem(new ConfLocalTextItem(428, "achievement_lock13", "解锁忧郁菇", "Unlock Melancholy Mushrooms"));
		AddItem(new ConfLocalTextItem(429, "achievement_lock14", "解锁双子向日葵", "Unlock Twin Sunflowers"));
		AddItem(new ConfLocalTextItem(430, "achievement_lock15", "解锁地刺王", "Unlock Thorn King"));
		AddItem(new ConfLocalTextItem(431, "achievement_lock16", "解锁毁灭菇", "Unlock Destruction Mushrooms"));
		AddItem(new ConfLocalTextItem(432, "achievement_lock17", "解锁道具篮球", "Unlock Prop Basketballs"));
		AddItem(new ConfLocalTextItem(433, "achievement_lock18", "解锁道具铁桶", "Unlock Prop Barrels"));
		AddItem(new ConfLocalTextItem(434, "achievement_lock19", "解锁道具橄榄球头盔", "Unlock Prop Football Helmets"));
		AddItem(new ConfLocalTextItem(435, "achievement_lock20", "解锁道具路牌", "Unlock Prop Signs"));
		AddItem(new ConfLocalTextItem(436, "achievement_lock21", "解锁道具报纸", "Unlock Prop Newspapers"));
		AddItem(new ConfLocalTextItem(437, "achievement_lock22", "解锁道具路障", "Unlock Prop Roadblocks"));
		AddItem(new ConfLocalTextItem(438, "achievement_lock23", "解锁道具铁栅栏", "Unlock Prop Fences"));
		AddItem(new ConfLocalTextItem(439, "achievement_lock24", "解锁道具扶梯", "Unlock Prop Escalators"));
		AddItem(new ConfLocalTextItem(440, "achievement_lock25", "解锁道具冰碎", "Unlock Prop Ice Crusher"));
		AddItem(new ConfLocalTextItem(441, "achievement_lock26", "解锁道具火焰", "Unlock Prop Flames"));
		AddItem(new ConfLocalTextItem(442, "achievement_lock27", "解锁道具车钥匙", "Unlock Prop Car Keys"));
		AddItem(new ConfLocalTextItem(443, "achievement_lock28", "", ""));
		AddItem(new ConfLocalTextItem(444, "achievement_lock29", "", ""));
		AddItem(new ConfLocalTextItem(445, "achievement_lock30", "", ""));
		AddItem(new ConfLocalTextItem(446, "achievement_lock31", "", ""));
		AddItem(new ConfLocalTextItem(447, "achievement_lock32", "", ""));
		AddItem(new ConfLocalTextItem(448, "achievement_lock33", "", ""));
		AddItem(new ConfLocalTextItem(449, "achievement_lock34", "", ""));
		AddItem(new ConfLocalTextItem(450, "achievement_lock35", "", ""));
		AddItem(new ConfLocalTextItem(451, "achievement_lock36", "", ""));
		AddItem(new ConfLocalTextItem(452, "achievement_lock37", "", ""));
		AddItem(new ConfLocalTextItem(453, "achievement_lock38", "", ""));
	}
