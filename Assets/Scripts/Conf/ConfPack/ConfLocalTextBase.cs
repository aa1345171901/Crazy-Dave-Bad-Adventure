...
public class ConfLocalTextBase : ConfBase<ConfLocalTextItem>
{
	...
	private void Init1()
	{
		...
		AddItem(new ConfLocalTextItem(383, "achievement_info5", "一局冒险中收集50个僵尸头", "Collected 50 zombie heads in one adventure"));
		AddItem(new ConfLocalTextItem(384, "achievement_info6", "一局冒险中收集200个僵尸头", "Collected 200 zombie heads in one adventure"));
		AddItem(new ConfLocalTextItem(385, "achievement_info7", "一局冒险中收集500个僵尸头", "Collected 500 zombie heads in one adventure"));
		...
		AddItem(new ConfLocalTextItem(389, "achievement_info11", "累计培养2次玉米投手", "Cultivated 2 times of corn pitchers"));
		AddItem(new ConfLocalTextItem(390, "achievement_info12", "第一次购买水花盆", "Buyed a water flower pot for the first time"));
		AddItem(new ConfLocalTextItem(391, "achievement_info13", "累计培养2次大喷菇", "Cultivated 2 times of giant mushrooms"));
		AddItem(new ConfLocalTextItem(392, "achievement_info14", "累计培养2次向日葵", "Cultivated 2 times of sunflowers"));
		AddItem(new ConfLocalTextItem(393, "achievement_info15", "累计培养2次地刺", "Cultivated 2 times of ground spikes"));
