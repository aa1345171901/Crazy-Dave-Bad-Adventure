...
# 娱乐模式游戏
道具模式  -- 配置表配置僵尸，开局拥有某道具，达成过关条件通关
植物模式  -- 配置表配置僵尸，限定使用某植物过关，达成通关条件
生存模式  -- 配置表配置僵尸，打僵尸掉落植物和道具，有通关条件（巨人，僵王），以及无尽模式

道具打怪爆

# 增加特殊伤害类型道具，额外功能
道具增加最大购买上限的次数配置。
大蒜 遗留1-4s持续伤害的臭屁气体， 每个增加1s，每s -1生命值   速度 +5  伤害 +4 幸运 -2 基础伤害1，每25植物学基础伤害+1 *百分比伤害  25 绿色
薄荷 购买了大蒜才能解锁，在臭屁中的僵尸减速      生命值 +5 生命恢复 +4  使大蒜的臭屁附加减速效果， 基础 减速 8%,多个可叠加  蓝色 64
火精灵 周期性向周围僵尸释放火柱，灰烬伤害      火星,火苗，火团，火精灵   --- 暴击，暴击伤害
火星  暴击伤害 +2 暴击率 +1  基础伤害1  造成伤害 （1 + 暴击率）* 暴击伤害 ，冷却时间5s,           绿 24
火苗  暴击伤害 +4 暴击率 +2  基础伤害3  造成伤害 （3 + 暴击率）* 暴击伤害 ，冷却时间4s,           蓝色 66
火团  暴击伤害 +8 暴击率 +4  基础伤害5  造成伤害 （5 + 暴击率）* 暴击伤害 ，冷却时间3s,               紫色 144
火精灵 暴击伤害 +20 暴击率 +10  基础伤害10  造成伤害 （10 + 暴击率 * 2）* 暴击伤害  释放（1 + 暴击伤害 / 50）道火柱   冷却时间2s,      红色 299

水精灵 向僵尸方向发射一道水流，附带击退和减速  水滴，水珠，水花，水精灵  -- 生命值，生命恢复
水滴  生命值 +2 生命恢复 +2  基础伤害1  造成伤害 （1 + 生命恢复 / 5 + 生命值 / 6） ，冷却时间8s,           绿 22
水珠  生命值 +4 生命恢复 +4  基础伤害3  造成伤害 （3 + 生命恢复 / 5 + 生命值 / 6） ，冷却时间6s,           蓝色 64
水花  生命值 +10 生命恢复 +10  基础伤害5  造成伤害 （5 + 生命恢复 / 5 + 生命值 / 6），冷却时间4s,               紫色 124
水精灵 生命值 +20 生命恢复 +20  基础伤害10  造成伤害 （10 + 生命恢复 / 2.5 + 生命值 / 3） 释放（1 + 生命值 / 100）道水流， 击退力度与生命值成正比,减速程度与生命恢复成正比   冷却时间2s,      红色 284

乌云  周期性降下闪电
肾上腺素 +25 暴击伤害 +10 阳光 +100 幸运 -2 护甲 -1  召唤乌云，在周围游走 造成伤害 （5 + 肾上腺素 / 5）* 暴击伤害  冷却时间6s  紫色 144

吸血鬼权杖 击杀僵尸永久增加生命值
当前最大生命值减半，每使用角色的攻击击杀10只僵尸，增加1最大生命值  34 绿色

钛合金头盔  免疫投篮僵尸禁止普攻的特点，转而造成伤害
护甲 +4 最大生命值 +10 范围 -5  蓝色 99
钛合金眼  可以精准攻击到天上的目标
范围 +10 暴击率 +2 护甲 +2 速度 -5  蓝色 88

死神  在头顶挥舞镰刀，造成范围伤害
肾上腺素 + 10 暴击伤害 +5 暴击率 +2 伤害 +5  最大生命值 -20   蓝色 66
当前生命值大于 50% 自动释放，消耗当前血量30%， 造成范围伤害 （消耗的血量 * 10） ,该伤害致死后收割目标灵魂，每个灵魂增加1最大生命值，每攻击到1个目标恢复（消耗的血量 / 6）血量

机枪小子 周期朝周围僵尸射击    手枪，冲锋枪，步枪
手枪 暴击伤害 +4 范围 +4 攻击速度 -4 伤害 -4  召唤手枪发射子弹造成（1 + 力量 / 2） * 伤害 冷却5s  绿色 24
ak69  暴击率 +2 攻击速度 +4 范围 +4 伤害 +4 幸运 -1 将一个手枪变为ak69,连续发射3颗子弹造成（3 + 力量） * 伤害  ，冷却4s  蓝 69
加特林 攻击速度 +10 力量 +2 肾上腺素 +4 护甲 +2 速度 -4  将一个ak69变为加特林,连续发射5颗子弹造成（5 + 力量） * 伤害  ，冷却3s 紫 124

暗精灵 在当前位置释放暗黑液体，持续伤害，有水精灵时额外减速     黑点，黑球，黑雾，暗精灵     --力量，伤害
光精灵 在角色附近降下光柱，使范围内的僵尸不能移动				光点，光芒，光照，光精灵     --幸运，植物学

# 花园
增加所有植物可以在游戏外种植
通过击杀僵尸掉落植物种子
掉落种子有稀有度权重设置以及稀有度颜色区分
在局外种植了植物后在局内会周期性掉落种植的随机植物卡片在角色周围
植物卡片一段时间消失，可以种植在任意位置，不可重叠
植物种植的越多掉落卡片周期越短，掉落内容从种植的植物中随机
...
图鉴显示植物和僵尸的动画
显示植物的培养属性，阳光和金币消耗
显示僵尸的速度，血量，攻击强度，弱点，隐晦显示攻击方式等
解锁前显示僵尸剪影，解锁后才显示动画

# 增加道具
破碎蛋壳 力量 +2 幸运 +2 护甲 -2  绿色 25
危险提醒  最大生命值 +5 肾上腺素 +5 伤害-5  绿色  22
护目镜 范围 +5 幸运+2 暴击伤害 +4 力量-1  绿色 20
法杖 暴击伤害 +15 暴击率 -3   绿色 28
贝壳 护甲 +4 速度 -3  绿色 22
锣 最大生命值 +4 肾上腺素 +5 暴击伤害 +4 速度 -3 僵尸数量增多5% 绿色 24
锣棍 生命恢复 +3 伤害 +6 暴击伤害 +4 植物学 -3 僵尸数量增多5% 绿色 24
点燃的炸弹 肾上腺素 +4 力量 +2 暴击率 +2 暴击伤害 +3 幸运-5 绿色 25
南瓜 最大生命值 +4 生命恢复 +2 幸运 +1 暴击率 -1 绿色 30
机翼 速度 +5 护甲 +2 暴击伤害 +4 暴击率 -2 绿色 24
锦旗 最大生命值 +5 生命恢复 +4 速度 +4 幸运 +2 僵尸数量增多10% 蓝色 55
破损滑板 速度 +5 力量 +1 幸运 -2 绿色 22
黄油 生命恢复 +4 暴击率 +2 速度 +2 暴击伤害 -10 绿色 20
操纵杆 速度 +4 攻击速度 +4 幸运 -2 绿色 22
录音机 幸运 +5 护甲 +2 金币 +5 植物学 +5 力量 -2 蓝色 50
假面 最大生命值 + 10 肾上腺素 +10 伤害 +5 攻击速度 +5 速度 +5 范围 -10 暴击率 -5 蓝色 70
鸡腿 最大生命值 + 8 生命恢复 +8 蓝色 66
云 速度 +6 范围 +6 伤害 +5 暴击率 -1 蓝色 45
冰块 伤害 +5 力量 +2 肾上腺素 +5 蓝色 50
蝠翼 速度 +10 范围 +5 伤害 +5 力量 -2  蓝色 45
裙摆 护甲 +5 幸运 +4 速度 -5 蓝色 47
伞 生命恢复 +5 伤害 +5  幸运 +4 范围 -5 蓝色 52
破碎的帽子 最大生命值 +5 护甲 +1 力量 +1 范围 -10 绿色 26
松果 最大生命值 +20 生命恢复 +10 伤害 +10 速度 +10 攻击速度 -5 护甲 -5 紫色 150
僵尸左手 暴击率 +10 暴击伤害 +20 肾上腺素 -10 幸运 -5  紫色 120
僵尸右手 力量 +8 伤害 +20 肾上腺素 -10 幸运 -5  紫色 120
模仿者 最大生命值 +50 生命恢复 +10 红色 300
底座 力量 +1 绿色 16
禁僵尸令 生命恢复 +5 力量 -1 僵尸数量减少 10% 绿色 15
撑杆跳杆 力量 +5 生命恢复 +5 范围 +5 攻击速度 +5 紫色 130
小推车 力量+2 速度 +5 蓝色 45
未知按钮 肾上腺素 +10 伤害 +5 幸运 +2 蓝色 56
冰车轮胎  速度 +10 生命恢复 +10 攻击速度 +5  100
...
玉米加农炮：基础伤害，百分比伤害，冷却时间，转换阳光率（血量500%的百分之多少），普通僵尸即死率，大型僵尸增伤，爆炸范围
